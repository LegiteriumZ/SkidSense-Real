package net.ccbluex.liquidbounce.utils.splash;
...
public class CustomSplashProgress {
    ...
    public static void start() {
        ...
        final ResourceLocation backgroundLoc = new ResourceLocation(getString("backgroundTexture", "assets/minecraft/fdpclient/splash.png"));
