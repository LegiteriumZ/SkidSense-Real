...
public class MainMenuButton {
    ...
    public void draw(float x, float y, int mouseX, int mouseY) {
        this.x = x;
        this.y = y;
        RenderUtils.drawRoundedCornerRect(x-30F,y-30F,x+30f,y+30f,50f,new Color(0,0,0,40).getRGB());
        ...
        RenderUtils.drawRoundedCornerRect(x-30F,y-30F,x+30f,y+30f,50f,new Color(255,255,255,50).getRGB());
    }
