...
import net.ccbluex.liquidbounce.ui.client.gui.modernui.Layer
...
class ModernGuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        /* For modification, please keep "Designed by XiGua" */
        FontLoaders.F16.drawString("Made By LegiteriumZ With Love :3",10f,this.height-15f,Color(255,255,255,170).rgb)
        var versionMsg="Version: "+LiquidBounce.CLIENT_VERSION+if (LiquidBounce.CLIENT_VERSION.contains("Release")) " | Release" else ""
    ...
    override fun actionPerformed(button: GuiButton) {
        when (button.id) {
            ...
            514 -> MiscUtils.showURL("https://${LiquidBounce.CLIENT_WEBSITE}/")
        }
    }
