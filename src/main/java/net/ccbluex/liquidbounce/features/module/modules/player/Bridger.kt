...
object LegitScaffold : Module() {
    ...
    override fun onEnable() {
        ...
        LiquidBounce.moduleManager[FreeLook::class.java]!!.enable()
        prevSlot = mc.thePlayer.inventory.currentItem
    }

    override fun onDisable() {

        LiquidBounce.moduleManager[FreeLook::class.java]!!.disable()
        ...
        when (modeValue.get().lowercase()) {
            "breezily" -> {
                ...
                if (mc.theWorld.getBlockState(
                    ...
                    ).block == Blocks.air && ((camYaw / 45).roundToInt()) % 2 == 0
                ) {
                    breezily = !breezily
            ...
            "simple" -> {
                ...
                if (safewalkValue.equals("Sneak")) {
                    mc.gameSettings.keyBindSneak.pressed =
                        (GameSettings.isKeyDown(mc.gameSettings.keyBindSneak) || mc.theWorld.getBlockState(
                            BlockPos(
                                mc.thePlayer.posX,
                                mc.thePlayer.posY - 1.0,
                                mc.thePlayer.posZ
